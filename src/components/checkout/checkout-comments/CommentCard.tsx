...
const AudioPlayer = dynamic(() => import('../checkout-comments/AudioPlayer'), {
  ssr: false,
  loading: () => <p>Loading...</p>,
});
/**
...
const CommentCard = ({ profileName, profileImage, date, title, text, image, rate, voice }: CommentsItem) => {
  /**
   * const and variables
   * _______________________________________________________________________________
   */
